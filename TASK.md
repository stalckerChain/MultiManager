# План реализации: Automation Matrix (v2.0.0)

## Обзор

Полная переработка модуля управления задачами/скриптами. Вместо плоской таблицы `tasks` — **матрица Проекты×Профили** с чекбоксами, групповыми запусками (runs) и цветной индикацией статусов.
