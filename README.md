...
> **Полная спецификация:** [TS.md](./TS.md) (MultiManager v1.2.1) + [TS_INTEGRATION.md](./TS_INTEGRATION.md) (stAuto0 интеграция).
> **Фазы Roadmap:** Ф1–Ф4 ✅, Ф5 ✅, **Ф6 ✅** (встроенный терминал).
...
- **Built-in Terminal:** xterm.js + IPC-мост для tail -f логов задач (powershell Get-Content / tail).
...
```
MultiManager/
├── TS.md                     # ТЕХНИЧЕСКОЕ ЗАДАНИЕ (MultiManager v1.2.0)
