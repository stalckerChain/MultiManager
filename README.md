...
- **Core-движок (Бэкенд):** Node.js, Express, SQLite (`better-sqlite3`, WAL+ACID), Pino, WebSocket (`ws`). Работает в фоновом режиме, управляет БД, отпечатками, процессами CloakBrowser, шифрованием секретов и задачами автоматизации.
...
│           ├── components/   # Layout, StatusBar, LogPanel, BrowserDownload
...
- `app.db` — SQLite (WAL). Профили, прокси, куки, задачи.
